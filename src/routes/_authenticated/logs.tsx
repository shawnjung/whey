  ...
  return (
    <div>
      <header className="pt-8 pb-6 px-6">
        <h1 className="text-2xl font-semibold tracking-tight">Your logs</h1>
      </header>
      ...
      <section className="px-4 mb-8">
        <div className="bg-brand rounded-[28px] p-6 flex items-center gap-6">
          ...
          <div>
            <p className="text-xs font-semibold uppercase tracking-wider text-brand-ink/60">Today</p>
      ...
      <section className="px-4">
        {loading ? (
          ...
          <p className="text-center text-sm text-muted-foreground py-6">Nothing logged yet. Tap + to start.</p>
        ) : (
            ...
            return (
              <div key={day} className="mb-6">
                <div className="flex justify-between items-baseline px-2 mb-2">
                  <h3 className="text-sm font-semibold">{day === new Date().toDateString() ? "Today" : day}</h3>
